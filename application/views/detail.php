...
<body>
	...
	<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
		...
		<symbol id="cart" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
			...
			<path fill="currentColor" d="M456.8 120.78a23.92 23.92 0 0 0-18.56-8.78H133.89l-6.13-34.78A16 16 0 0 0 112 64H48a16 16 0 0 0 0 32h50.58l45.66 258.78A16 16 0 0 0 160 368h256a16 16 0 0 0 0-32H173.42l-5.64-32h241.66A24.07 24.07 0 0 0 433 284.71l28.8-144a24 24 0 0 0-5-19.93Z"></path>
		</symbol>
		<symbol id="long-arrow-alt-left" xmlns="http://www.w3.org/2000/svg" class="la" viewBox="0 0 32 32">
			<title>Long Arrow Left</title>
			<path fill="currentColor" d="M10.813 9.281L4.093 16l6.72 6.719l1.406-1.438L7.938 17H28v-2H7.937l4.282-4.281z"></path>
		</symbol>
		<symbol id="long-arrow-alt-right" xmlns="http://www.w3.org/2000/svg" class="la" viewBox="0 0 32 32">
			<title>Long Arrow Right</title>
			<path fill="currentColor" d="M21.188 9.281L19.78 10.72L24.063 15H4v2h20.063l-4.282 4.281l1.407 1.438L27.905 16z"></path>
		</symbol>
		...
		<symbol id="arrow-forward" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
			...
			<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="m268 112l144 144l-144 144m124-144H100"></path>
		</symbol>
		<symbol id="chevron-forward" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
			<title>Chevron Forward</title>
			<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="m184 112l144 144l-144 144"></path>
		</symbol>
		<symbol id="play" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
			<title>Play</title>
			<path fill="currentColor" d="M133 440a35.37 35.37 0 0 1-17.5-4.67c-12-6.8-19.46-20-19.46-34.33V111c0-14.37 7.46-27.53 19.46-34.33a35.13 35.13 0 0 1 35.77.45l247.85 148.36a36 36 0 0 1 0 61l-247.89 148.4A35.5 35.5 0 0 1 133 440Z"></path>
		</symbol>
		<symbol id="menu-sharp" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
			<title>Menu</title>
			<path fill="currentColor" d="M64 384h384v-42.67H64Zm0-106.67h384v-42.66H64ZM64 128v42.67h384V128Z"></path>
		</symbol>
		<symbol id="close-sharp" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
			<title>Cross</title>
			<path fill="currentColor" d="M400 145.49L366.51 112L256 222.51L145.49 112L112 145.49L222.51 256L112 366.51L145.49 400L256 289.49L366.51 400L400 366.51L289.49 256L400 145.49z"></path>
		</symbol>
	</svg>
				...
				<div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
					...
					<div class="page-title text-center">
						...
						<div class="breadcum-items">
							...
							<span class="item colored">Detail Berita</span>
						</div>
					</div>
			...
			<div class="row">
				<article class="post-item">
					<div class="post-content">
						<div class="post-meta">
							<span class="post-category"><?= $konten->tanggal; ?> </span> / <span class="meta-date"><a href="blog.html"><?= $konten->nama_kategori; ?></a></span>
						</div>
						<h1 class="post-title"><?= $konten->judul; ?></h1>
						<div class="hero-image col-lg-12 mt-5">
							<img src="<?= base_url('assets/upload/konten/' . $konten->foto) ?>" alt="single-post" class="img-fluid">
						</div>
							...
							<div class="post-bottom-link my-3 d-flex flex-wrap justify-content-between">
								<div class="social-links d-flex">
									...
									<ul class="d-flex list-unstyled">
										<li><a href="#" class="mx-2"><svg class="bi" width="16" height="16">
													<use xlink:href="#logo-facebook"></use>
												</svg></a></li>
										<li><a href="#" class="mx-2"><svg class="bi" width="16" height="16">
													<use xlink:href="#logo-twitter"></use>
		...
		<div class="container">
			<div class="title-wrap d-flex justify-content-between">
				<div class="section-header">
					<h4 class="elementary-title">Recent Posts</h4>
				</div><!--section-header-->
			</div>
			<div class="row">
				<?php foreach ($rencent as $rcn) { ?>
					<div class="post-item col-md-3">
						<figure class="zoom-effect">
							<a href="single-post.html" class="zoom-in"><img src="<?= base_url('assets/upload/konten/' . $rcn['foto']) ?>" style="width: 500px; height: 200px;"  alt="stories" class="blogImg img-fluid"></a>
						</figure>
						<div class="story-title-wrap mt-3">
							<div class="post-meta"><a href="blog.html"><?= $rcn['nama_kategori'] ?></a></div>
							<h3 class="story-title"><a href="<?= base_url('home/artikel/' . $rcn['slug']) ?>"><?= $rcn['judul'] ?></a></h3>
							<div class="entry-meta">
								<span class="author"><span class="sp">by</span><span class="author-name"><?= $rcn['username'] ?></span></span>
