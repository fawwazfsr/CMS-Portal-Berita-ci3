            ...
            <div class="row">
                <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                    ...
                    <div class="page-title text-center">
                        <h2>Menampilkan Kategori : "<?= $nama_kategori; ?>"</h2>
                        <div class="breadcum-items">
                            <span class="item"><a href="<?= base_url() ?>">Home /</a></span>
                            <span class="item colored">Kategori</span>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="product-card link-effect pe-3 pb-3">
                                    <figure class="zoom-effect">
                                        <a href="single-product.html" class="zoom-in"><img src="<?= base_url('assets/upload/konten/' . $aa['foto']) ?>" style="width: 500px; height: 200px;" class="lgpostImg img-fluid"></a>
                                    </figure>
                                    <div class="story-title-wrap mt-3">
                                        <div class="post-meta"><a href="blog.html"><?= $aa['nama_kategori'] ?></a></div>
                                        <h3 class="story-title"><a href="<?= base_url('home/artikel/' . $aa['slug']) ?>"><?= $aa['judul']; ?></a></h3>
                                        <div class="entry-meta">
                                            <span class="author"><span class="sp">by</span><span class="author-name"><?= $aa['nama']; ?></span></span>
                                            <span class="meta-date"><span class="sp">-</span><time class="published"><?= $aa['tanggal']; ?></time></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
