...
<body>
    ...
    <div class="section search-result-wrap">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="heading">Category: <?= $nama_kategori; ?></div>
                </div>
            </div>
                    ...
                    <?php foreach ($konten as $aa) { ?>
                        <div class="blog-entry d-flex blog-entry-search-item">
                            <a href="single.html" class="img-link me-4">
                                <img src="<?= base_url('assets/upload/konten/' . $aa['foto']) ?>" width="1200px" height="800px" alt="Image" class="img-fluid">
                            </a>
                            <div>
                                <span class="date"><?= $aa['tanggal'] ?> &bullet; <a href="#"><?= $aa['nama_kategori'] ?></a></span>
                                <h2>
                                    <a href="single.html"> <?= $aa['judul'] ?></a>
                                </h2>
                                <p><?= mb_substr( $aa['keterangan'], 0, 100, 'UTF-8'); ?></p>
                                <p><a href="<?= base_url('home/artikel/' . $aa['slug']) ?>" class="btn btn-sm btn-outline-primary">Read More</a></p>
                            </div>
                        </div>
                    <?php } ?>
